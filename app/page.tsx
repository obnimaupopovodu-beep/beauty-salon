      ...
      <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(231,221,210,0.45),_transparent_32%),linear-gradient(180deg,_#faf8f5_0%,_#f4efe9_100%)]">
        ...
        <main id="top">
          ...
          <section className="relative overflow-hidden">
            {/* Фигуры — z-index:-1 через CSS, находятся в потоке section */}
            ...
            {/* Контент — isolation:isolate отделяет его stacking context */}
            <div className="section-inner mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 sm:py-20 lg:grid-cols-[1.15fr_0.85fr] lg:px-8 lg:py-24">
              <div className="max-w-3xl">
                ...
                <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                  <a href="#booking" className="inline-flex items-center justify-center rounded-full bg-stone-900 px-6 py-4 text-sm font-semibold text-white transition hover:bg-stone-800">
                    Записаться
                  </a>
                  <a href={business.phoneHref} className="inline-flex items-center justify-center rounded-full border border-stone-300 bg-white px-6 py-4 text-sm font-semibold text-stone-900 transition hover:border-stone-400">
                    Позвонить
                  </a>
                  <a href={business.routeHref} target="_blank" rel="noreferrer" className="inline-flex items-center justify-center rounded-full border border-transparent px-2 py-4 text-sm font-semibold text-stone-700 transition hover:text-stone-900">
                    Построить маршрут
                  </a>
                </div>
              ...
              <aside className="relative lg:pl-6">
                ...
                <div className="section-inner overflow-hidden rounded-[2rem] border border-stone-200/80 bg-white/90 p-6 shadow-soft">
                  <div aria-hidden className="ornament-wave absolute -right-10 bottom-2 h-40 w-56 opacity-25" />
                  <div className="section-inner rounded-[1.5rem] bg-stone-900 px-5 py-4 text-white">
          ...
          <section aria-label="Доверие" className="relative overflow-hidden border-y border-stone-200/80 bg-white/70">
            ...
            <div className="section-inner mx-auto grid max-w-7xl gap-4 px-4 py-6 sm:grid-cols-2 sm:px-6 lg:grid-cols-4 lg:px-8">
              {trustPoints.map((point) => (
          ...
          <section aria-label="Акции" className="relative overflow-hidden bg-stone-900 text-stone-100">
            ...
            <div className="section-inner mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
          ...
          <section id="services" className="relative overflow-hidden">
            ...
            <div className="section-inner mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
              <SectionTitle
              ...
              <div className="mt-10 grid gap-5 md:grid-cols-2 xl:grid-cols-4">
                {popularServices.map((service) => (
                  ...
                  >
                    ...
                    <a href="#booking" className="mt-4 inline-block text-sm font-medium text-stone-900 underline-offset-2 hover:underline">
                      Записаться →
                    </a>
                  </article>
                ))}
          ...
          <section className="relative overflow-hidden bg-stone-900 text-stone-100">
            ...
            <div aria-hidden className="ornament-rings absolute left-[8%] top-10 h-24 w-24 opacity-30" />
            <div className="section-inner mx-auto grid max-w-7xl gap-8 px-4 py-16 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8 lg:py-24">
              <div>
        ...
        <footer className="relative overflow-hidden border-t border-stone-200/80 bg-white/80">
          ...
          <div className="section-inner mx-auto flex max-w-7xl flex-col gap-6 px-4 py-8 text-sm text-stone-600 sm:px-6 lg:flex-row lg:items-end lg:justify-between lg:px-8">
